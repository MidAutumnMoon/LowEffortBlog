...
What? Why?? Is my motherboard busted? Is my beloved NixOS betraying me? Is my custom built Kernel punishing me for not RTFM? Frustratingly the situation was beyond what I can debug.
...
3. Set kernel parameter `nohz_full` to include desired CPUs, for example `nohz_full=2-15`.
    ...
    Cores *not included in* the list will *housekeeping* interrupts for the others which could potentially stay in deeper C-State longer because of less interrupts, resulting "energy saving".
