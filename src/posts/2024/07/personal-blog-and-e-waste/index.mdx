...
The fact this blog is built on top of such a foundation makes me uneasy. If `$life` takes a lot from me keeping me from gardening my JavaScript for months, will it still build? Or worse, is the motivation still for me to re-pickup the JavaScript garbage? Is it really the right choice to do my blog in such way? Let's find out in the future.
